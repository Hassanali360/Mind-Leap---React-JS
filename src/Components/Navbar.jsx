    ...
    <ul className="flex font-medium flex-col md:flex-row lg:space-x-8 sm:space-x-4 space-y-2 md:space-y-0 p-4 md:p-0 pt-2 items-center">
      {["home", "services", "about", "testimonial"].map((id) => (
        <li key={id}>
          <a
            ...
            className={`text-black capitalize ${activeSection === id ? "isActive" : ""}`}
          >
            {id === "testimonial" ? "Projects" : id}
          </a>
        </li>
      ))}
      ...
      <li>
        <button
          ...
          className="text-white bg-heroBg hover:bg-white hover:text-black hover:font-bold px-4 py-2 rounded"
        >
          Signup
        </button>
      </li>
